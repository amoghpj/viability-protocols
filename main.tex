...
\begin{enumerate}
    ...
    \amogh{Stamp out the formulation plates between 9 AM and noon}
    \bradley{Prepare the drying plate-racks, and place them with empty boxes in the BSC}

    
    \item Check if samples (60x10mLx2 replicates) are actually frozen. \amogh{} \colin{} \zeina{}
    ...
    \item \amogh{generate one of these stamps into a microscopy source plate}, so \bradley{microscopy of plates to look for fungi}
